...
hist(h1P, breaks=10, freq=T, col='darkgreen', main='Comparing influence of salt on plant growth vs mortality', xlab='Plant biomass') 
hist(h2P, breaks=10, freq=T, col='black', add=T)

hist(h1M, breaks=10, freq=T, col='darkgreen', main='Comparing influence of salt on plant growth (red) vs mortality(blue)', xlab='soil moisture') 
hist(h2M, breaks=10, freq=T, col='black', add=T)

hist(h1SmM, breaks=10, freq=T, col='darkgreen', main='Comparing influence of salt on plant growth (red) vs mortality(blue)', xlab='soil salt mass') 
