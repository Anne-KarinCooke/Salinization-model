...
#     nvg <- 1.237
  ...
  Z =20000 # [mm] actual groundwater depth 
...
```{r VariableerClimates}
alpha <- c(0.6,0.6) #c(0.6,1.5) 
lambda <- c(0.1,1)
...
baseP<- lambda_sum$P
baseM <-lambda_sum$M
baseSmM<-lambda_sum$SmM
baseCM<-lambda_sum$CM
```
...
#   h_sub[tt+1] <- h.old + ifelse(tt==1,(10*Rain[t]),0) 
    ...
    h_sub[tt+1] <- h.old + (10*Rain[t]*timeincr)


# + 10*Ran[t]*timeincr as a first test
# ifelse(tt==6,....) and ifelse(tt==12,...)
# the last one could be a rainstorm distribution
...
#   h_sub[tt+1] <- h.old + ifelse(tt==1,(10*Rain[t]),0) 
    ...
    h_sub[tt+1] <- h.old + ifelse(tt==6,(10*Rain[t]),0)
...
# Storage vectors for the substeps are initialized.
  ...
  # Balance for water depth on soil
  h_sub[tt+1] <- h.old + ifelse(tt==4,(10*Rain[t]*0.1),0) +ifelse(tt==5,(10*Rain[t]*0.2),0)  +ifelse(tt==6,(10*Rain[t]*0.4),0)
  +ifelse(tt==7,(10*Rain[t]*0.2),0) +ifelse(tt==8,(10*Rain[t]*0.1),0)
...
art1P<- lambda_sum$P
art1M <-lambda_sum$M
art1SmM<-lambda_sum$SmM
art1CM<-lambda_sum$CM
```
...
# Storage vectors for the substeps are initialized.
  ...
  # Balance for water depth on soil
  h_sub[tt+1] <- h.old + ifelse(tt==9,(10*Rain[t]*0.25),0) +ifelse(tt==10,(10*Rain[t]*0.75),0)  
...
art2P<- lambda_sum$P
art2M <-lambda_sum$M
art2SmM<-lambda_sum$SmM
art2CM<-lambda_sum$CM
```


```{r}
summary(baseP[5000:10000]) # Plant biomass base
summary(h1P[5000:10000]) # Plant biomass exp 1
summary(h2P[5000:10000]) # Plant biomass exp 2
summary(art1P[5000:10000]) # Plant biomass exp 3
summary(art2P[5000:10000]) # Plant biomass exp 4

summary(baseM[5000:10000]) # soil moisture base 
summary(h1M[5000:10000]) # soil moisture exp 1
summary(h2M[5000:10000]) # soil moisture exp 2
summary(art1M[5000:10000]) # soil moisture exp 2
summary(art2M[5000:10000]) # soil moisture exp 2

summary(baseSmM[5000:10000]) # soil salt mass base 
summary(h1SmM[5000:10000]) # soil salt mass exp 1
summary(h2SmM[5000:10000]) # soil salt mass exp 2
summary(art1SmM[5000:10000]) # soil salt mass exp 3
summary(art2SmM[5000:10000]) # soil salt mass exp 4

summary(baseCM[5000:10000]) # soil salt concentration base
summary(h1CM[5000:10000]) # soil salt concentration exp 1
summary(h2CM[5000:10000]) # soil salt concentration exp 2
summary(art1CM[5000:10000]) # soil salt concentration exp 3
summary(art2CM[5000:10000]) # soil salt concentration exp 4

```

```{r}
par(mfrow = c(2,2))
hist(baseP[5000:10000], breaks=10, main = 'Plant biomass Base')
hist(h1P[5000:10000], breaks=10, main = 'Plant biomass 1')
hist(h2P[5000:10000], breaks=10, main = 'Plant biomass 2')
hist(art1P[5000:10000], breaks=10, main = 'Plant biomass 3')
hist(art2P[5000:10000], breaks=10, main = 'Plant biomass 4')

hist(baseM[5000:10000], breaks=10,main="Soil moisture base")
hist(h1M[5000:10000], breaks=10,main="Soil moisture 1")
hist(h2M[5000:10000], breaks=10,main="Soil moisture 2")
hist(art1M[5000:10000], breaks=10,main="Soil moisture 3")
hist(art2M[5000:10000], breaks=10,main="Soil moisture 4")

hist(baseSmM[5000:10000], breaks=10,main="soil salt mass base")
hist(h1SmM[5000:10000], breaks=10,main="soil salt mass 1")
hist(h2SmM[5000:10000], breaks=10,main="soil salt mass 2")
hist(art1SmM[5000:10000], breaks=10,main="soil salt mass 3")
hist(art2SmM[5000:10000], breaks=10,main="soil salt mass 4")


hist(baseCM[5000:10000], breaks=10, main="Salt concentration in soil base")
hist(h1CM[5000:10000], breaks=10, main="Salt concentration in soil 1")
hist(h2CM[5000:10000], breaks=10, main="Salt concentration in soil 2")
hist(art1CM[5000:10000], breaks=10, main="Salt concentration in soil 3")
hist(art2CM[5000:10000], breaks=10, main="Salt concentration in soil 4")
...
wilcox.test(baseM[5000:10000],h1M[5000:10000]) # soil moisture
wilcox.test(baseM[5000:10000],h2M[5000:10000]) # soil moisture
wilcox.test(baseM[5000:10000],art1M[5000:10000]) # soil moisture
wilcox.test(baseM[5000:10000],art2M[5000:10000]) # soil moisture

wilcox.test(baseP[5000:10000],h1P[5000:10000]) # plant biomass
wilcox.test(baseP[5000:10000],h2P[5000:10000]) # plant biomass
wilcox.test(baseP[5000:10000],art1P[5000:10000]) # plant biomass
wilcox.test(baseP[5000:10000],art2P[5000:10000]) # plant biomass

wilcox.test(baseSmM[5000:10000],h1SmM[5000:10000]) # soil salt mass
wilcox.test(baseSmM[5000:10000],h2SmM[5000:10000]) # soil salt mass
wilcox.test(baseSmM[5000:10000],art1SmM[5000:10000]) # soil salt mass
wilcox.test(baseSmM[5000:10000],art2SmM[5000:10000]) # soil salt mass

wilcox.test(baseCM[5000:10000],h1CM[5000:10000]) # soil salt concentration
wilcox.test(baseCM[5000:10000],h2CM[5000:10000]) # soil salt concentration
wilcox.test(baseCM[5000:10000],art1CM[5000:10000]) # soil salt concentration
wilcox.test(baseCM[5000:10000],art2CM[5000:10000]) # soil salt concentration
