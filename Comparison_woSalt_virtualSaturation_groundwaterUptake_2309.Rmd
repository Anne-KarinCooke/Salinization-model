...
# Balance for water depth on soil
      ...
      h_sub[tt+1] <- h.old + ifelse(tt==1,Rain[t],0) - Infil(h.old, P.old)*timeincr + Overflow[tt]
...
### This is new
  if (U_sub[tt]> (soilpar$s_fc*(soilpar$n*soilpar$Zr))-M_sub[tt]){
      Overflow[tt] <- U_sub[tt]-((soilpar$s_fc*(soilpar$n*soilpar$Zr))-M_sub[tt])
  }
