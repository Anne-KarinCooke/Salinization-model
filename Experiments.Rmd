...
# parameters describing plant dynamics and salt features
  ...
  d=0.1 # fraction of plant mortality
...
Although the histograms of plant biomass and salt concentration show small differences, statistically none of the four examined distributions (P, M, SmM, CM) are significantly different. The two experiments don't show distinctly different results, at least not for these chosen scenarios.
