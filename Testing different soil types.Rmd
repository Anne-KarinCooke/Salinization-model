...
# parameters describing plant dynamics and salt features
  ...
  alpha_i=K_s #maximum infiltration rate per day, http://www.fao.org/docrep/s8684e/s8684e0a.htm
...
# change in multiplier 10* rainfall to make mm
...
Soil moisture differes significantly between all, with being the highest in heavy clay  and lowest in coarse sand. Plant biomass shows sign. differences between all three soils and is therefore and logically, also highest in heavy clay and lowest in coarse sand.  Salt mass does not differ significantly.
Salt concentrations do differ significantly between sandy clay loam and coarse sand and heavy clay and coarse sand, with heavy clay showing the highest mean but coarse sand showing the highest peaks.

Generally, model outputs with coarse sand appear much more erratic and unstable, amplitudes are large and plants tend to die more easily than in the other two soil types.
