...
# parameters describing the soil
  soilpar <- list(b = b, n = n, s_fc = s_fc, K_s = K_s, 
                psi_s_bar = psi_s_bar, h1bar = h1bar, hb = hb, m=m)
    #................................................
    # Vegetation 1 (Grass)
...
# parameters describing plant dynamics and salt features
  ...
  alpha_i=K_s/Z #maximum infiltration rate per day
...
q <-((((Znd/hb_nd)^-soilpar$m)-((psi/hb)^-soilpar$m))/((1+((psi/hb)^-soilpar$m))+((m-1)*((Znd/hb_nd)^-soilpar$m)))) # 
...
flux<-ifelse(s<soilpar$s_fc, abs(flux)/10, -abs(flux))
