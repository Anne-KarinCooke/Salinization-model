...
```{r}
summary(baseP) # Plant biomass base
summary(h1P) # Plant biomass exp 1
summary(h2P) # Plant biomass exp 2
summary(art1P) # Plant biomass exp 3
summary(art2P) # Plant biomass exp 4

summary(baseM) # soil moisture base 
summary(h1M) # soil moisture exp 1
summary(h2M) # soil moisture exp 2
summary(art1M) # soil moisture exp 2
summary(art2M) # soil moisture exp 2

summary(baseSmM) # soil salt mass base 
summary(h1SmM) # soil salt mass exp 1
summary(h2SmM) # soil salt mass exp 2
summary(art1SmM) # soil salt mass exp 3
summary(art2SmM) # soil salt mass exp 4

summary(baseCM) # soil salt concentration base
summary(h1CM) # soil salt concentration exp 1
summary(h2CM) # soil salt concentration exp 2
summary(art1CM) # soil salt concentration exp 3
summary(art2CM) # soil salt concentration exp 4

```

```{r}
par(mfrow = c(2,2))
hist(baseP, breaks=10, main = 'Plant biomass Base')
hist(h1P, breaks=10, main = 'Plant biomass 1')
hist(h2P, breaks=10, main = 'Plant biomass 2')
hist(art1P, breaks=10, main = 'Plant biomass 3')
hist(art2P, breaks=10, main = 'Plant biomass 4')

hist(baseM, breaks=10,main="Soil moisture base")
hist(h1M, breaks=10,main="Soil moisture 1")
hist(h2M, breaks=10,main="Soil moisture 2")
hist(art1M, breaks=10,main="Soil moisture 3")
hist(art2M, breaks=10,main="Soil moisture 4")

hist(baseSmM, breaks=10,main="soil salt mass base")
hist(h1SmM, breaks=10,main="soil salt mass 1")
hist(h2SmM, breaks=10,main="soil salt mass 2")
hist(art1SmM, breaks=10,main="soil salt mass 3")
hist(art2SmM, breaks=10,main="soil salt mass 4")


hist(baseCM, breaks=10, main="Salt concentration in soil base")
hist(h1CM, breaks=10, main="Salt concentration in soil 1")
hist(h2CM, breaks=10, main="Salt concentration in soil 2")
hist(art1CM, breaks=10, main="Salt concentration in soil 3")
hist(art2CM, breaks=10, main="Salt concentration in soil 4")
...
wilcox.test(baseM,h1M) # soil moisture
wilcox.test(baseM,h2M) # soil moisture
wilcox.test(baseM,art1M) # soil moisture
wilcox.test(baseM,art2M) # soil moisture

wilcox.test(baseP,h1P) # plant biomass
wilcox.test(baseP,h2P) # plant biomass
wilcox.test(baseP,art1P) # plant biomass
wilcox.test(baseP,art2P) # plant biomass

wilcox.test(baseSmM,h1SmM) # soil salt mass
wilcox.test(baseSmM,h2SmM) # soil salt mass
wilcox.test(baseSmM,art2SmM) # soil salt mass
wilcox.test(baseSmM,art2SmM) # soil salt mass

wilcox.test(baseCM,h1CM) # soil salt concentration
wilcox.test(baseCM,h2CM) # soil salt concentration
wilcox.test(baseCM,art2CM) # soil salt concentration
wilcox.test(baseCM,art2CM) # soil salt concentration
