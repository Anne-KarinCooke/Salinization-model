...
# Calculate salt concentration in the soil
      CM_sub[tt]<- SmM_sub[tt]/M_sub[tt] #tt+1
...
#   }
  ...
  M_sub[tt + 1] <- ifelse(Overflow[tt] >0,M_sub[tt + 1] - L_sub[tt]*timeincr + U_sub[tt]*timeincr - Overflow[tt],M_sub[tt + 1] <- M_sub[tt + 1] - L_sub[tt]*timeincr + U_sub[tt]*timeincr)
